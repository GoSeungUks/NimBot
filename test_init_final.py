...
def init():
	...
	### 채널 고정###
	basicSetting[6] = int('633958120502067219') #보이스채널ID
	basicSetting[7] = int('633958316707545088') #택스트채널ID
...
async def on_ready():
	...
	await client.change_presence(status=discord.Status.idle, activity=discord.Game(name="정산! 분배!", type=1))
